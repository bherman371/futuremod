...
public class ModItems {
	...
	public static final Item FUTURE_STICK = new ItemBase("future_stick");
	public static final Item ATOMIC_STICK = new ItemBase("atomic_stick");
	public static final Item NUCLEAR_STICK = new ItemBase("nuclear_stick");
